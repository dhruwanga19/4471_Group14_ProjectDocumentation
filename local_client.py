...
user_service_url = 'http://localhost:5000'  # Replace with the actual URL of your User Service
product_service_url = 'http://localhost:5001'  # Replace with the actual URL of your Product Service
